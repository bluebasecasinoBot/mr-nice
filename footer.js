...
__SYD.footer = function()
{
    return $(
        "div",
        {style:"height:fit-content;width:100%;padding:15px;display:flex;justify-content:center;align-items:cente;background-color:#F3BA2F;border-top:3px solid #000000;"},
        [
