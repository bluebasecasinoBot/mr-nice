...
__SYD.page5 = function()
{
    return $(
        "div",
        {
            style:"display:flex;justify-content:center;align-items:center;gap:20px;width:100%;padding:15px;padding-bottom:50px;padding-top:80px;font-family:font2;position:relative;min-height:100vh;width:100vw;position:relative;background-color:transparent;background-image:url(./assets/p5.png);",
            id:'about'
        },
        [
            __SYD.p5_text()
