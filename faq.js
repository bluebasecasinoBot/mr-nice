    ...
    return $(
        ...
        [
            ...
            $(
                "div",
                {
                    style:`height:100%;width:100%;max-width:1300px;display:flex;align-items:flex-start;gap:20px;padding:0 ${__p(["faqSubHeader" , "mobilePadState"],false) ? "10px" : "60px"};flex-direction:${__p(["faqSubHeader" , "breakVal"],false) ? "column" : "row"}`
                },
                [
                    $(
                        "div",
...
__SYD.faq_text3 = () =>{
    return $(
        ...
        {},
        [
            $("p" , {style:`${SYD_VAR.pag1SubText.get()} text-align:center;color:#ffffff;`},["You’re not the only one. We put together some quick answers about Mr. Nice, the coin, and what this whole $xingsworld thing is about. Dive in and see what’s up."])
        ]
    )
}
...
__SYD.faq_text4 = (textContent) =>{
    return $(
        ...
        {},
        [
            $("p" , {style:`${SYD_VAR.pag1SubText.get()} padding:10px 20px;color:#ffffff;`},[textContent])
        ]
    )
}
    ...
    return $(
        ...
        [
            ...
            __SYD.questionTab({
                ...
                answer:"$xingsworld is the official Solana-based meme coin dedicated to Mr. Nice and his ever-growing kingdom. It’s more than a token—it’s a movement powered by cat lovers, degens, and dreamers.",
                index:1
            }),
            __SYD.questionTab({
                question:"Why Solana?",
                answer:"Because speed matters! Solana is fast, cheap, and perfect for meme coins that want to go to the moon without gas fees burning your wallet.",
                index:2
            }),
            __SYD.questionTab({
                question:"How do I get $xingsworld?",
                answer:"Easy—head to your favorite Solana DEX (like Raydium or Jupiter), connect your wallet, and swap for $xingsworld. Simple as scratching a post.",
                index:3
            }),
            __SYD.questionTab({
    ...
    return $(
        ...
        [
            $(
                "div",
                {
                    style:"height:60px;width:100%;cursor:pointer;padding:10px 20px;align-items:center;display:flex;position:relative;font-weight:700;border:3px solid #000000;border-radius:15px;color:#000000;background:#FFD633;"
                },
                [
                    question,
                    $(
                        "span",
                        {
                            style:"height:30px;width:30px;position:absolute;top:50%;transform:translateY(-50%);right:15px;pointer-events:none;transition:transform linear .3s;background-image:url(./assets/plus.svg);",
                        },[],{genericStyle:["bg_fit"]}
                    )
